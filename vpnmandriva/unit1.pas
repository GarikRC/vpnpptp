...
If CheckBox_required.Checked then
                   begin
                      If not FileExists(UsrBinDir+'strings') then If not FileExists(UsrBinDir+'man') then If (CheckBox_required.Checked) or (CheckBox_stateless.Checked) or (CheckBox_no40.Checked) or (CheckBox_no56.Checked) or (CheckBox_no128.Checked) then
                                                                                                     begin
                                                                                                          If FallbackLang='ru' then Application.MessageBox(PChar(message76ru+' '+UsrBinDir+'strings, '+UsrBinDir+'man.'),PChar(message0ru),0) else
                                                                                                                                                                                                if FallbackLang='uk' then Application.MessageBox(PChar(message76uk+' '+UsrBinDir+'strings, '+UsrBinDir+'man.'),PChar(message0uk),0)
                                                                                                                                                                                                                                      else Application.MessageBox(PChar(message76en+' '+UsrBinDir+'strings, '+UsrBinDir+'man.'),PChar(message0en),0);
                                                                                                     end;
                      if error_man_pppd then
                                         begin
                                              If FallbackLang='ru' then Application.MessageBox(PChar(message82ru+' '+UsrBinDir+'strings.'),PChar(message0ru),0) else
                                                                                                                                            if FallbackLang='uk' then Application.MessageBox(PChar(message82uk+' '+UsrBinDir+'strings.'),PChar(message0uk),0)
                                                                                                                                                                                                                                      else Application.MessageBox(PChar(message82en+' '+UsrBinDir+'strings.'),PChar(message0en),0);
                                         end;
                          ...
                          begin
                               repeat
                                     ...
                                     If (Edit_IPS.Text='connect.lb.swissvpn.net') and (Edit_user.Text='swissvpntest') and (Edit_passwd.Text='swissvpntest') then
                                                                                                                          AAsyncProcess.CommandLine :=BinDir+'ping -c1 swissvpn.net' else
                                                                                                                                        AAsyncProcess.CommandLine :=BinDir+'ping -c1 yandex.ru';
...
If DirectoryExists(UsrBinDir) then
     If ParamStr(0)<>UsrBinDir+'vpnmandriva' then
        If DirectoryExists(MyVpnDir) then
            If ParamStr(0)<>'/opt/vpnpptp/trunk/vpnmandriva/vpnmandriva' then
                                                                  begin
