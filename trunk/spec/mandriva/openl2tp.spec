...
Requires: ppp == 2.4.5, readline >= 4.2
ExclusiveOS: Linux
...
%{_mandir}/man1/l2tpconfig.1.lzma
%{_mandir}/man4/openl2tp_rpc.4.lzma
%{_mandir}/man5/openl2tpd.conf.5.lzma
%{_mandir}/man7/openl2tp.7.lzma
%{_mandir}/man8/openl2tpd.8.lzma
